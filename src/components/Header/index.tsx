        ...
        <div className="flex w-full py-5 ">
          ...
          <div className="flex flex-col w-2/3 text-gray-700 bg-yellow-rubraz rounded-full font-bold items-start max-w-[740px] ">
            ...
            <div className="flex lg:px-4 px-6 gap-4 text-lg flex-nowrap lg:flex-nowrap h-full w-full ">
              <div className="flex flex-col lg:w-1/3 w-2/3 items-center justify-center ">
              ...
              <div className="flex flex-col lg:w-1/3 w-1/8 items-center lg:items-end justify-center ">
                    ...
                    <div className="absolute top-24 ">
                      <div className="bg-white shadow-md rounded-lg py-4 px-6 mt-2 relative z-20">
                        ...
                        <ul className="flex flex-col gap-4">
                          <li><a href='https://www.facebook.com/rubrazlajes' target='_blank' className='text-blue-rubraz flex items-center gap-2'><FaFacebookF className='text-2xl'/> Facebook</a></li>
                          <li><a href='https://www.instagram.com/rubrazlajes/' target='_blank' className='text-blue-rubraz flex items-center gap-2'><FaInstagram className='text-2xl'/> Instagram</a></li>
                          <li><a href='https://rubrazlajes.com/' target="_blank" className='text-blue-rubraz flex items-center gap-2'>rubrazlajes.com</a></li>
                        </ul>
                      </div>
                    </div>
                  )}
